...
export interface IPrimexDNSStorageInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "aavePool"
...
export interface IPrimexDNSStorage extends BaseContract {
  connect(runner?: ContractRunner | null): IPrimexDNSStorage;
  waitForDeployment(): Promise<this>;

  interface: IPrimexDNSStorageInterface;
