...
export interface IPrimexDNSStorageV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "aavePool"
      | "additionalGasSpent"
...
export interface IPrimexDNSStorageV3 extends BaseContract {
  connect(runner?: ContractRunner | null): IPrimexDNSStorageV3;
  waitForDeployment(): Promise<this>;

  interface: IPrimexDNSStorageV3Interface;
