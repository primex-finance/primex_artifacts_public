...
export interface IPrimexDNSV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "aavePool"
      | "activateBucket"
...
export interface IPrimexDNSV3 extends BaseContract {
  connect(runner?: ContractRunner | null): IPrimexDNSV3;
