...
export interface PrimexDNSStorageV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "aavePool"
      | "additionalGasSpent"
...
export interface PrimexDNSStorageV3 extends BaseContract {
  connect(runner?: ContractRunner | null): PrimexDNSStorageV3;
