...
export interface PrimexDNSStorageInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "aavePool"
...
export interface PrimexDNSStorage extends BaseContract {
  connect(runner?: ContractRunner | null): PrimexDNSStorage;
