...
export interface IBatchManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "closeBatchPositions"
      | "gasPerBatch"
  ...
  getEvent(
    nameOrSignatureOrTopic: "ChangeGasPerBatch" | "ChangeGasPerPosition"
  ): EventFragment;
...
export interface IBatchManager extends BaseContract {
  connect(runner?: ContractRunner | null): IBatchManager;
  ...
  ): TypedContractMethod<[_gasPerBatch: BigNumberish], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "setGasPerPosition"
  ): TypedContractMethod<[_gasPerPosition: BigNumberish], [void], "nonpayable">;
  getFunction(
