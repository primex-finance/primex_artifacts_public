...
export interface WhiteBlackListInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface WhiteBlackList extends BaseContract {
  connect(runner?: ContractRunner | null): WhiteBlackList;
  waitForDeployment(): Promise<this>;

  interface: WhiteBlackListInterface;
