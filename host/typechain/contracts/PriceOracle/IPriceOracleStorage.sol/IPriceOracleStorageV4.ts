...
export interface IPriceOracleStorageV4Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IPriceOracleStorageV4 extends BaseContract {
  connect(runner?: ContractRunner | null): IPriceOracleStorageV4;
  waitForDeployment(): Promise<this>;

  interface: IPriceOracleStorageV4Interface;
