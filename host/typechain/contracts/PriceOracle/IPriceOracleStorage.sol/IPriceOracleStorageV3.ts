...
export interface IPriceOracleStorageV3Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface IPriceOracleStorageV3 extends BaseContract {
  connect(runner?: ContractRunner | null): IPriceOracleStorageV3;
