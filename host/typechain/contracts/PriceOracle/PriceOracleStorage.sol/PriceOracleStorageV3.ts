...
export interface PriceOracleStorageV3Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PriceOracleStorageV3 extends BaseContract {
  connect(runner?: ContractRunner | null): PriceOracleStorageV3;
  waitForDeployment(): Promise<this>;

  interface: PriceOracleStorageV3Interface;
