...
export interface PositionManagerStorageV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "bucketPositionIds"
...
export interface PositionManagerStorageV2 extends BaseContract {
  connect(runner?: ContractRunner | null): PositionManagerStorageV2;
  waitForDeployment(): Promise<this>;

  interface: PositionManagerStorageV2Interface;
