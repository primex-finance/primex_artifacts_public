...
export interface IPositionManagerExtensionInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "decreaseDeposit"
...
export interface IPositionManagerExtension extends BaseContract {
  connect(runner?: ContractRunner | null): IPositionManagerExtension;
