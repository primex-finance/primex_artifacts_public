...
export interface IPositionManagerV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "bucketPositionIds"
      | "closePosition"
...
export interface IPositionManagerV2 extends BaseContract {
  connect(runner?: ContractRunner | null): IPositionManagerV2;
