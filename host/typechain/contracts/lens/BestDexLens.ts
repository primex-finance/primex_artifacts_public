...
export interface BestDexLensInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getBestDexByOrder"
...
export interface BestDexLens extends BaseContract {
  connect(runner?: ContractRunner | null): BestDexLens;
  waitForDeployment(): Promise<this>;

  interface: BestDexLensInterface;
