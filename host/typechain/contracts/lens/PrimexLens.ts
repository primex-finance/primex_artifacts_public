...
export interface PrimexLensInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PrimexLens extends BaseContract {
  connect(runner?: ContractRunner | null): PrimexLens;
  ...
  getArrayOpenPositionDataByBucket: TypedContractMethod<
    ...
    [
      [IPrimexLens.OpenPositionDataStructOutput[], bigint] & {
        positionsData: IPrimexLens.OpenPositionDataStructOutput[];
        newCursor: bigint;
      }
    ],
    "view"
  ...
  getBucket: TypedContractMethod<
    [_bucket: AddressLike, _user: AddressLike],
    [IPrimexLens.BucketMetaDataStructOutput],
    "view"
  >;
  ...
  getLMBucketInfo: TypedContractMethod<
    [liquidityMiningRewardDistributor: AddressLike, bucketName: string],
  ...
  getLimitOrdersWithConditions: TypedContractMethod<
    ...
    [
      [IPrimexLens.LimitOrderWithConditionsStructOutput[], bigint] & {
        limitOrdersWithConditions: IPrimexLens.LimitOrderWithConditionsStructOutput[];
        newCursor: bigint;
      }
    ],
    "view"
  ...
  getOpenPositionsWithConditions: TypedContractMethod<
    ...
    [
      [IPrimexLens.OpenPositionWithConditionsStructOutput[], bigint] & {
        openPositionsWithConditions: IPrimexLens.OpenPositionWithConditionsStructOutput[];
        newCursor: bigint;
      }
    ],
    "view"
  ...
  takeProfitStopLossCCM: TypedContractMethod<[], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "takeProfitStopLossCCM"
