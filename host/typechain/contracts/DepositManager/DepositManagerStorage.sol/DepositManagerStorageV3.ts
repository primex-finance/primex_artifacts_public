...
export interface DepositManagerStorageV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "bucketRewardTokens"
      | "depositIdCounter"
...
export interface DepositManagerStorageV3 extends BaseContract {
  connect(runner?: ContractRunner | null): DepositManagerStorageV3;
  waitForDeployment(): Promise<this>;

  interface: DepositManagerStorageV3Interface;
