...
export interface BucketsFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allBuckets"
      | "buckets"
...
export interface BucketsFactory extends BaseContract {
  connect(runner?: ContractRunner | null): BucketsFactory;
