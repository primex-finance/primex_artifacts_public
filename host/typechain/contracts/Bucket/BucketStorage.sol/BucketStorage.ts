...
export interface BucketStorageInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "aaveDeposit"
      | "allowedAssets"
...
export interface BucketStorage extends BaseContract {
  connect(runner?: ContractRunner | null): BucketStorage;
