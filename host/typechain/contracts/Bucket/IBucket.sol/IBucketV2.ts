...
export interface IBucketV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "addAsset"
      | "allowedAssets"
...
export interface IBucketV2 extends BaseContract {
  connect(runner?: ContractRunner | null): IBucketV2;
  waitForDeployment(): Promise<this>;

  interface: IBucketV2Interface;
  ...
  maxAssetLeverage: TypedContractMethod<
    [_asset: AddressLike],
    [bigint],
    "view"
  >;
  ...
  withdraw: TypedContractMethod<
    [_borrowAssetReceiver: AddressLike, amount: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "maxAssetLeverage"
