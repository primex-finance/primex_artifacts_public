...
export interface IBucketV4Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "addAsset"
      | "allowedAssets"
...
export interface IBucketV4 extends BaseContract {
  connect(runner?: ContractRunner | null): IBucketV4;
  ...
  cumulateToLiquidityIndex: TypedContractMethod<
    [amount: BigNumberish, availableLiquidity: BigNumberish],
    [void],
    "nonpayable"
  >;
