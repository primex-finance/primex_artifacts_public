...
export interface CurveStableOracleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getAddressProvider"
      | "getPoolInfo"
...
export interface CurveStableOracle extends BaseContract {
  connect(runner?: ContractRunner | null): CurveStableOracle;
  waitForDeployment(): Promise<this>;

  interface: CurveStableOracleInterface;
