...
export interface CurveTricryptoOracleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "getAddressProvider"
      | "getPoolInfo"
...
export interface CurveTricryptoOracle extends BaseContract {
  connect(runner?: ContractRunner | null): CurveTricryptoOracle;
  waitForDeployment(): Promise<this>;

  interface: CurveTricryptoOracleInterface;
