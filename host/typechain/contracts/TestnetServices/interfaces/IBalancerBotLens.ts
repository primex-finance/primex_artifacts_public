...
export interface IBalancerBotLensInterface extends Interface {
...
export interface IBalancerBotLens extends BaseContract {
  connect(runner?: ContractRunner | null): IBalancerBotLens;
