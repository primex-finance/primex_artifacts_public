...
export interface PrimexTimelockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface PrimexTimelock extends BaseContract {
  connect(runner?: ContractRunner | null): PrimexTimelock;
  waitForDeployment(): Promise<this>;

  interface: PrimexTimelockInterface;
  ...
  updateDelay: TypedContractMethod<[arg0: BigNumberish], [void], "view">;
