...
export interface MockNearestSearchInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "activateBonus"
      | "bucketBonusCount"
...
export interface MockNearestSearch extends BaseContract {
  connect(runner?: ContractRunner | null): MockNearestSearch;
