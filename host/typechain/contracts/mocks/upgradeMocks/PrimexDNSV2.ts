...
export interface PrimexDNSV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "aavePool"
      | "activateBucket"
...
export interface PrimexDNSV2 extends BaseContract {
  connect(runner?: ContractRunner | null): PrimexDNSV2;
