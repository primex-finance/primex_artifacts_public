...
export interface KeeperRewardDistributorV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "additionalGas"
      | "claim"
...
export interface KeeperRewardDistributorV2 extends BaseContract {
  connect(runner?: ContractRunner | null): KeeperRewardDistributorV2;
  waitForDeployment(): Promise<this>;

  interface: KeeperRewardDistributorV2Interface;
