...
export interface FeeDecreaserV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "activateBonus"
      | "bucketBonusCount"
...
export interface FeeDecreaserV2 extends BaseContract {
  connect(runner?: ContractRunner | null): FeeDecreaserV2;
  waitForDeployment(): Promise<this>;

  interface: FeeDecreaserV2Interface;
