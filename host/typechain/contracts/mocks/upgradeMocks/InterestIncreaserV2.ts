...
export interface InterestIncreaserV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "activateBonus"
      | "bucketBonusCount"
...
export interface InterestIncreaserV2 extends BaseContract {
  connect(runner?: ContractRunner | null): InterestIncreaserV2;
  waitForDeployment(): Promise<this>;

  interface: InterestIncreaserV2Interface;
