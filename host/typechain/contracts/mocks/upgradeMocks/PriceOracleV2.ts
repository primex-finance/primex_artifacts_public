...
export interface PriceOracleV2Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PriceOracleV2 extends BaseContract {
  connect(runner?: ContractRunner | null): PriceOracleV2;
  waitForDeployment(): Promise<this>;

  interface: PriceOracleV2Interface;
  ...
  updatePullOracle: TypedContractMethod<
    [_data: BytesLike[][], _oracleTypes: BigNumberish[]],
    [void],
    "payable"
  >;
