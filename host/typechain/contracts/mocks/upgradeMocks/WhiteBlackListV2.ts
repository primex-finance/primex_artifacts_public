...
export interface WhiteBlackListV2Interface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface WhiteBlackListV2 extends BaseContract {
  connect(runner?: ContractRunner | null): WhiteBlackListV2;
  waitForDeployment(): Promise<this>;

  interface: WhiteBlackListV2Interface;
