...
export interface DebtTokenV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface DebtTokenV2 extends BaseContract {
  connect(runner?: ContractRunner | null): DebtTokenV2;
  waitForDeployment(): Promise<this>;

  interface: DebtTokenV2Interface;
