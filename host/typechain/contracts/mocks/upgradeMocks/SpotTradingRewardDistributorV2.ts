...
export interface SpotTradingRewardDistributorV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "calculateReward"
      | "claimReward"
...
export interface SpotTradingRewardDistributorV2 extends BaseContract {
  connect(runner?: ContractRunner | null): SpotTradingRewardDistributorV2;
  waitForDeployment(): Promise<this>;

  interface: SpotTradingRewardDistributorV2Interface;
