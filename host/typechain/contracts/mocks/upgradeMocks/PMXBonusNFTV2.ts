...
export interface PMXBonusNFTV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "activate"
      | "approve"
...
export interface PMXBonusNFTV2 extends BaseContract {
  connect(runner?: ContractRunner | null): PMXBonusNFTV2;
  waitForDeployment(): Promise<this>;

  interface: PMXBonusNFTV2Interface;
