...
export interface PrimexPricingLibraryMockInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PrimexPricingLibraryMock extends BaseContract {
  connect(runner?: ContractRunner | null): PrimexPricingLibraryMock;
