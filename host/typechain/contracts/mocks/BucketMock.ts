...
export interface BucketMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addAsset"
      | "allowedAssets"
...
export interface BucketMock extends BaseContract {
  connect(runner?: ContractRunner | null): BucketMock;
  ...
  normalizedIncome: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "normalizedIncome"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
