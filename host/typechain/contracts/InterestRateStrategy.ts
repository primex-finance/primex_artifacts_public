...
export interface InterestRateStrategyInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface InterestRateStrategy extends BaseContract {
  connect(runner?: ContractRunner | null): InterestRateStrategy;
