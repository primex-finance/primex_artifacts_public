...
export interface IPrimexNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface IPrimexNFT extends BaseContract {
  connect(runner?: ContractRunner | null): IPrimexNFT;
  waitForDeployment(): Promise<this>;

  interface: IPrimexNFTInterface;
