...
export interface IPTokenStorageInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface IPTokenStorage extends BaseContract {
  connect(runner?: ContractRunner | null): IPTokenStorage;
  waitForDeployment(): Promise<this>;

  interface: IPTokenStorageInterface;
