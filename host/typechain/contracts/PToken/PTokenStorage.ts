...
export interface PTokenStorageInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface PTokenStorage extends BaseContract {
  connect(runner?: ContractRunner | null): PTokenStorage;
  waitForDeployment(): Promise<this>;

  interface: PTokenStorageInterface;
