...
export interface EPMXPriceFeedInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "decimals"
      | "description"
...
export interface EPMXPriceFeed extends BaseContract {
  connect(runner?: ContractRunner | null): EPMXPriceFeed;
  waitForDeployment(): Promise<this>;

  interface: EPMXPriceFeedInterface;
