...
export interface IDebtTokenStorageInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface IDebtTokenStorage extends BaseContract {
  connect(runner?: ContractRunner | null): IDebtTokenStorage;
  waitForDeployment(): Promise<this>;

  interface: IDebtTokenStorageInterface;
