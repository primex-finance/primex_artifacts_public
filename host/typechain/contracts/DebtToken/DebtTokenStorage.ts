...
export interface DebtTokenStorageInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface DebtTokenStorage extends BaseContract {
  connect(runner?: ContractRunner | null): DebtTokenStorage;
  waitForDeployment(): Promise<this>;

  interface: DebtTokenStorageInterface;
