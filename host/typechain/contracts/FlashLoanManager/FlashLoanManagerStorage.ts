...
export interface FlashLoanManagerStorageInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "flashLoanFeeRate"
...
export interface FlashLoanManagerStorage extends BaseContract {
  connect(runner?: ContractRunner | null): FlashLoanManagerStorage;
