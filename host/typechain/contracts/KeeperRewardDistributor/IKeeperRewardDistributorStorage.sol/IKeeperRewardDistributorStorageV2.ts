...
export interface IKeeperRewardDistributorStorageV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "additionalGas"
...
export interface IKeeperRewardDistributorStorageV2 extends BaseContract {
  connect(runner?: ContractRunner | null): IKeeperRewardDistributorStorageV2;
