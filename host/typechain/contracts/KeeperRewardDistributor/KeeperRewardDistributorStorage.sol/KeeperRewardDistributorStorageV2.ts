...
export interface KeeperRewardDistributorStorageV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "additionalGas"
...
export interface KeeperRewardDistributorStorageV2 extends BaseContract {
  connect(runner?: ContractRunner | null): KeeperRewardDistributorStorageV2;
  waitForDeployment(): Promise<this>;

  interface: KeeperRewardDistributorStorageV2Interface;
