...
export interface KeeperRewardDistributorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "additionalGas"
      | "claim"
...
export interface KeeperRewardDistributor extends BaseContract {
  connect(runner?: ContractRunner | null): KeeperRewardDistributor;
