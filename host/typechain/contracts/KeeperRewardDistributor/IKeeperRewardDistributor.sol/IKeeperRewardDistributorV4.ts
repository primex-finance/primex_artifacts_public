...
export interface IKeeperRewardDistributorV4Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "additionalGas"
      | "claim"
...
export interface IKeeperRewardDistributorV4 extends BaseContract {
  connect(runner?: ContractRunner | null): IKeeperRewardDistributorV4;
  waitForDeployment(): Promise<this>;

  interface: IKeeperRewardDistributorV4Interface;
