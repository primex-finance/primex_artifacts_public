...
export interface InterestIncreaserInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "activateBonus"
      | "bucketBonusCount"
...
export interface InterestIncreaser extends BaseContract {
  connect(runner?: ContractRunner | null): InterestIncreaser;
  waitForDeployment(): Promise<this>;

  interface: InterestIncreaserInterface;
