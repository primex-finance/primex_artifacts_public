...
export interface IStorkVerifyInterface extends Interface {
...
export interface IStorkVerify extends BaseContract {
  connect(runner?: ContractRunner | null): IStorkVerify;
  waitForDeployment(): Promise<this>;

  interface: IStorkVerifyInterface;
