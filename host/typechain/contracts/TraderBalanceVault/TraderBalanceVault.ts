...
export interface TraderBalanceVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balances"
...
export interface TraderBalanceVault extends BaseContract {
  connect(runner?: ContractRunner | null): TraderBalanceVault;
  waitForDeployment(): Promise<this>;

  interface: TraderBalanceVaultInterface;
