...
export interface ITraderBalanceVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "balances"
...
export interface ITraderBalanceVault extends BaseContract {
  connect(runner?: ContractRunner | null): ITraderBalanceVault;
  waitForDeployment(): Promise<this>;

  interface: ITraderBalanceVaultInterface;
