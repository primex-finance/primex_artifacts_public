...
export interface ITraderBalanceVaultV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "balances"
...
export interface ITraderBalanceVaultV2 extends BaseContract {
  connect(runner?: ContractRunner | null): ITraderBalanceVaultV2;
  waitForDeployment(): Promise<this>;

  interface: ITraderBalanceVaultV2Interface;
