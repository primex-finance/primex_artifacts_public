...
export interface LimitOrderManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "bucketOrderIds"
      | "bucketOrderIndexes"
...
export interface LimitOrderManager extends BaseContract {
  connect(runner?: ContractRunner | null): LimitOrderManager;
  waitForDeployment(): Promise<this>;

  interface: LimitOrderManagerInterface;
