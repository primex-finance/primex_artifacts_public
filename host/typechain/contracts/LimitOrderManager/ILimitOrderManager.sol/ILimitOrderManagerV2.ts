...
export interface ILimitOrderManagerV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "bucketOrderIds"
      | "bucketOrderIndexes"
...
export interface ILimitOrderManagerV2 extends BaseContract {
  connect(runner?: ContractRunner | null): ILimitOrderManagerV2;
  waitForDeployment(): Promise<this>;

  interface: ILimitOrderManagerV2Interface;
