...
export interface PMXBonusNFTStorageInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface PMXBonusNFTStorage extends BaseContract {
  connect(runner?: ContractRunner | null): PMXBonusNFTStorage;
  waitForDeployment(): Promise<this>;

  interface: PMXBonusNFTStorageInterface;
