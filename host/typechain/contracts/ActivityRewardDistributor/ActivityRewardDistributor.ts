...
export interface ActivityRewardDistributorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "buckets"
      | "claimReward"
...
export interface ActivityRewardDistributor extends BaseContract {
  connect(runner?: ContractRunner | null): ActivityRewardDistributor;
