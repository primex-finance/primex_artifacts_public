...
export interface PrimexRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "getRoleAdmin"
...
export interface PrimexRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): PrimexRegistry;
