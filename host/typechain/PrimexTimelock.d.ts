...
interface PrimexTimelockInterface extends ethers.utils.Interface {
  functions: {
...
export class PrimexTimelock extends BaseContract {
  ...
  functions: {
    ...
    updateDelay(arg0: BigNumberish, overrides?: CallOverrides): Promise<[void]>;
  };
