...
interface OVMGasPriceOracleMockInterface extends ethers.utils.Interface {
  functions: {
...
export class OVMGasPriceOracleMock extends BaseContract {
  ...
  interface: OVMGasPriceOracleMockInterface;
