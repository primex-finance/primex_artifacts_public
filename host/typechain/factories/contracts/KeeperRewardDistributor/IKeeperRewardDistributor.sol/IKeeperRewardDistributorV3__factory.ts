...
import type {
  IKeeperRewardDistributorV3,
  IKeeperRewardDistributorV3Interface,
} from "../../../../contracts/KeeperRewardDistributor/IKeeperRewardDistributor.sol/IKeeperRewardDistributorV3";
...
export class IKeeperRewardDistributorV3__factory {
  static readonly abi = _abi;
  static createInterface(): IKeeperRewardDistributorV3Interface {
    return new Interface(_abi) as IKeeperRewardDistributorV3Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IKeeperRewardDistributorV3;
  }
}
