...
} from "../../../../contracts/KeeperRewardDistributor/KeeperRewardDistributorStorage.sol/KeeperRewardDistributorStorage";
...
export class KeeperRewardDistributorStorage__factory {
  ...
  static createInterface(): KeeperRewardDistributorStorageInterface {
    return new Interface(_abi) as KeeperRewardDistributorStorageInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as KeeperRewardDistributorStorage;
  }
}
