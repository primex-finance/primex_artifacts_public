...
} from "../../../../contracts/KeeperRewardDistributor/IKeeperRewardDistributorStorage.sol/IKeeperRewardDistributorStorageV2";
...
export class IKeeperRewardDistributorStorageV2__factory {
  ...
  static createInterface(): IKeeperRewardDistributorStorageV2Interface {
    return new Interface(_abi) as IKeeperRewardDistributorStorageV2Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IKeeperRewardDistributorStorageV2;
  }
}
