...
} from "../../../../contracts/mocks/NonStandardERC20.sol/UpgradedStandardToken";
...
export class UpgradedStandardToken__factory {
  ...
  static createInterface(): UpgradedStandardTokenInterface {
    return new Interface(_abi) as UpgradedStandardTokenInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as UpgradedStandardToken;
  }
}
