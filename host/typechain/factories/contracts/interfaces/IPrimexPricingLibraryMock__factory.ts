...
} from "../../../contracts/interfaces/IPrimexPricingLibraryMock";
...
export class IPrimexPricingLibraryMock__factory {
  ...
  static createInterface(): IPrimexPricingLibraryMockInterface {
    return new Interface(_abi) as IPrimexPricingLibraryMockInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IPrimexPricingLibraryMock;
  }
}
