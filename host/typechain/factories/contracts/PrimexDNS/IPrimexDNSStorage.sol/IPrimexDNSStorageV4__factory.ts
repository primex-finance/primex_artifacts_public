...
import type {
  IPrimexDNSStorageV4,
  IPrimexDNSStorageV4Interface,
} from "../../../../contracts/PrimexDNS/IPrimexDNSStorage.sol/IPrimexDNSStorageV4";
...
export class IPrimexDNSStorageV4__factory {
  static readonly abi = _abi;
  static createInterface(): IPrimexDNSStorageV4Interface {
    return new Interface(_abi) as IPrimexDNSStorageV4Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IPrimexDNSStorageV4;
  }
}
