...
import type {
  IDepositManagerV2,
  IDepositManagerV2Interface,
} from "../../../../contracts/DepositManager/IDepositManager.sol/IDepositManagerV2";
...
export class IDepositManagerV2__factory {
  static readonly abi = _abi;
  static createInterface(): IDepositManagerV2Interface {
    return new utils.Interface(_abi) as IDepositManagerV2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IDepositManagerV2 {
    return new Contract(address, _abi, signerOrProvider) as IDepositManagerV2;
  }
}
