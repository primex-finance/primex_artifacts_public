...
import type {
  IPositionManagerV2,
  IPositionManagerV2Interface,
} from "../../../../contracts/PositionManager/IPositionManager.sol/IPositionManagerV2";
...
export class IPositionManagerV2__factory {
  static readonly abi = _abi;
  static createInterface(): IPositionManagerV2Interface {
    return new Interface(_abi) as IPositionManagerV2Interface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IPositionManagerV2 {
    return new Contract(address, _abi, runner) as unknown as IPositionManagerV2;
  }
}
