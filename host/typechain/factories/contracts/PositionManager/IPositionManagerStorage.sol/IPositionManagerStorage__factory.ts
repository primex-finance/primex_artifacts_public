...
} from "../../../../contracts/PositionManager/IPositionManagerStorage.sol/IPositionManagerStorage";
...
export class IPositionManagerStorage__factory {
  ...
  static createInterface(): IPositionManagerStorageInterface {
    return new Interface(_abi) as IPositionManagerStorageInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IPositionManagerStorage;
  }
}
