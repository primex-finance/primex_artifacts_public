...
} from "../../../contracts/Bucket/IBucketExtension";
...
export class IBucketExtension__factory {
  ...
  static createInterface(): IBucketExtensionInterface {
    return new Interface(_abi) as IBucketExtensionInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IBucketExtension {
    return new Contract(address, _abi, runner) as unknown as IBucketExtension;
  }
}
