...
import type {
  BucketStorage,
  BucketStorageInterface,
} from "../../../../contracts/Bucket/BucketStorage.sol/BucketStorage";
...
export class BucketStorage__factory {
  static readonly abi = _abi;
  static createInterface(): BucketStorageInterface {
    return new Interface(_abi) as BucketStorageInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): BucketStorage {
    return new Contract(address, _abi, runner) as unknown as BucketStorage;
  }
}
