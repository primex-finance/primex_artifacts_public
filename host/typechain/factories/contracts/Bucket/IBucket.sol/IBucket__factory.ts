...
import type {
  IBucket,
  IBucketInterface,
} from "../../../../contracts/Bucket/IBucket.sol/IBucket";
...
export class IBucket__factory {
  static readonly abi = _abi;
  static createInterface(): IBucketInterface {
    return new Interface(_abi) as IBucketInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IBucket {
    return new Contract(address, _abi, runner) as unknown as IBucket;
  }
}
