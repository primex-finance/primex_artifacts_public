...
import type {
  ITraderBalanceVaultV2,
  ITraderBalanceVaultV2Interface,
} from "../../../../contracts/TraderBalanceVault/ITraderBalanceVault.sol/ITraderBalanceVaultV2";
...
export class ITraderBalanceVaultV2__factory {
  static readonly abi = _abi;
  static createInterface(): ITraderBalanceVaultV2Interface {
    return new Interface(_abi) as ITraderBalanceVaultV2Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as ITraderBalanceVaultV2;
  }
}
