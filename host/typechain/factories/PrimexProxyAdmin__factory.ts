...
export class PrimexProxyAdmin__factory extends ContractFactory {
  ...
  ): Promise<PrimexProxyAdmin> {
    return super.deploy(
      _registry,
      overrides || {}
    ) as Promise<PrimexProxyAdmin>;
  }
  ...
  attach(address: string): PrimexProxyAdmin {
    return super.attach(address) as PrimexProxyAdmin;
  }
  connect(signer: Signer): PrimexProxyAdmin__factory {
    return super.connect(signer) as PrimexProxyAdmin__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): PrimexProxyAdminInterface {
    return new utils.Interface(_abi) as PrimexProxyAdminInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PrimexProxyAdmin {
    return new Contract(address, _abi, signerOrProvider) as PrimexProxyAdmin;
  }
}
