...
import type { IBucketV3, IBucketV3Interface } from "../IBucketV3";
...
export class IBucketV3__factory {
  ...
  static createInterface(): IBucketV3Interface {
    return new utils.Interface(_abi) as IBucketV3Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IBucketV3 {
    return new Contract(address, _abi, signerOrProvider) as IBucketV3;
  }
}
