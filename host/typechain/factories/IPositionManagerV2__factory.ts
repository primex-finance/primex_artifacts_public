...
export class IPositionManagerV2__factory {
  ...
  static createInterface(): IPositionManagerV2Interface {
    return new utils.Interface(_abi) as IPositionManagerV2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IPositionManagerV2 {
    return new Contract(address, _abi, signerOrProvider) as IPositionManagerV2;
  }
}
