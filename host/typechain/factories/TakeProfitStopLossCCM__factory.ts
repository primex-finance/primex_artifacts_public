...
export class TakeProfitStopLossCCM__factory extends ContractFactory {
  ...
  ): Promise<TakeProfitStopLossCCM> {
    return super.deploy(
      _registry,
      overrides || {}
    ) as Promise<TakeProfitStopLossCCM>;
  }
  ...
  attach(address: string): TakeProfitStopLossCCM {
    return super.attach(address) as TakeProfitStopLossCCM;
  }
  connect(signer: Signer): TakeProfitStopLossCCM__factory {
    return super.connect(signer) as TakeProfitStopLossCCM__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): TakeProfitStopLossCCMInterface {
    return new utils.Interface(_abi) as TakeProfitStopLossCCMInterface;
  }
  static connect(
    address: string,
