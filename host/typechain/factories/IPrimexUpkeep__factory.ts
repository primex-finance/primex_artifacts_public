...
import type { IPrimexUpkeep, IPrimexUpkeepInterface } from "../IPrimexUpkeep";
...
export class IPrimexUpkeep__factory {
  ...
  static createInterface(): IPrimexUpkeepInterface {
    return new utils.Interface(_abi) as IPrimexUpkeepInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IPrimexUpkeep {
    return new Contract(address, _abi, signerOrProvider) as IPrimexUpkeep;
  }
}
