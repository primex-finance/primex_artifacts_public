...
import type {
  ...
  IDataStorageOperatorInterface,
} from "../../../../../@cryptoalgebra/solidity-interfaces/contracts/core/IDataStorageOperator";
...
export class IDataStorageOperator__factory {
  ...
  static createInterface(): IDataStorageOperatorInterface {
    return new Interface(_abi) as IDataStorageOperatorInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as IDataStorageOperator;
  }
}
