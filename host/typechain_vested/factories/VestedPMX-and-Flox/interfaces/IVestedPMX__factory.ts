...
import type {
  IVestedPMX,
  IVestedPMXInterface,
} from "../../../VestedPMX-and-Flox/interfaces/IVestedPMX";
...
export class IVestedPMX__factory {
  static readonly abi = _abi;
  static createInterface(): IVestedPMXInterface {
    return new Interface(_abi) as IVestedPMXInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IVestedPMX {
    return new Contract(address, _abi, runner) as unknown as IVestedPMX;
  }
}
