...
export interface OwnedV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "nominateNewOwner"
...
export interface OwnedV2 extends BaseContract {
  connect(runner?: ContractRunner | null): OwnedV2;
  waitForDeployment(): Promise<this>;

  interface: OwnedV2Interface;
