...
export declare namespace IlFPISStructs {
  ...
  export type PointStructOutput = [
    ...
    blk: bigint,
    fpisAmt: bigint
  ] & { bias: bigint; slope: bigint; ts: bigint; blk: bigint; fpisAmt: bigint };
}

export interface IFPISLockerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAXTIME_INT128"
      | "MAXTIME_UINT256"
      ...
      | "MAX_USER_LOCKS"
      | "MULTIPLIER_UINT256"
      | "PMX_CONVERSION_START_TIMESTAMP"
      | "VOTE_END_POWER_BASIS_POINTS_INT128"
  ...
  encodeFunctionData(
    functionFragment: "MAX_BASIS_POINTS_INT128",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "PMX_CONVERSION_START_TIMESTAMP",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "VOTE_END_POWER_BASIS_POINTS_INT128",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setLVPIDUtils",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [IlFPISStructs.PointStruct, BigNumberish]
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "totalFPISSupply",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "totalFPISSupplyAt",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export interface IFPISLocker extends BaseContract {
  connect(runner?: ContractRunner | null): IFPISLocker;
  waitForDeployment(): Promise<this>;

  interface: IFPISLockerInterface;
  ...
  MAX_BASIS_POINTS_INT128: TypedContractMethod<[], [bigint], "view">;
  ...
  PMX_CONVERSION_START_TIMESTAMP: TypedContractMethod<[], [bigint], "view">;

  VOTE_END_POWER_BASIS_POINTS_INT128: TypedContractMethod<[], [bigint], "view">;
  ...
  lockedById: TypedContractMethod<
    ...
    [IlFPISStructs.LockedBalanceStructOutput],
    "view"
  >;
  ...
  setLVPIDUtils: TypedContractMethod<
    [_lFpisUtilsAddr: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  supplyAt: TypedContractMethod<
    [_point: IlFPISStructs.PointStruct, _t: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  totalFPISSupply: TypedContractMethod<[], [bigint], "view">;

  totalFPISSupplyAt: TypedContractMethod<
    [_block: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "MAX_BASIS_POINTS_INT128"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "PMX_CONVERSION_START_TIMESTAMP"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "VOTE_END_POWER_BASIS_POINTS_INT128"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "setLVPIDUtils"
  ): TypedContractMethod<[_lFpisUtilsAddr: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "totalFPISSupply"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "totalFPISSupplyAt"
