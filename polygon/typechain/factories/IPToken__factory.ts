...
import type { IPToken, IPTokenInterface } from "../IPToken";
...
export class IPToken__factory {
  static readonly abi = _abi;
  static createInterface(): IPTokenInterface {
    return new utils.Interface(_abi) as IPTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IPToken {
    return new Contract(address, _abi, signerOrProvider) as IPToken;
  }
}
