...
import type { IBucketV4, IBucketV4Interface } from "../IBucketV4";
...
export class IBucketV4__factory {
  ...
  static createInterface(): IBucketV4Interface {
    return new utils.Interface(_abi) as IBucketV4Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IBucketV4 {
    return new Contract(address, _abi, signerOrProvider) as IBucketV4;
  }
}
