...
import type { BestDexLens, BestDexLensInterface } from "../BestDexLens";
...
export class BestDexLens__factory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(overrides || {}) as Promise<BestDexLens>;
  }
  ...
  attach(address: string): BestDexLens {
    return super.attach(address) as BestDexLens;
  }
  connect(signer: Signer): BestDexLens__factory {
    return super.connect(signer) as BestDexLens__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): BestDexLensInterface {
    return new utils.Interface(_abi) as BestDexLensInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BestDexLens {
    return new Contract(address, _abi, signerOrProvider) as BestDexLens;
  }
}
