...
} from "../LiquidityMiningRewardDistributorStorage";
...
export class LiquidityMiningRewardDistributorStorage__factory extends ContractFactory {
  ...
  ): Promise<LiquidityMiningRewardDistributorStorage> {
    return super.deploy(
      overrides || {}
    ) as Promise<LiquidityMiningRewardDistributorStorage>;
  }
  ...
  attach(address: string): LiquidityMiningRewardDistributorStorage {
    return super.attach(address) as LiquidityMiningRewardDistributorStorage;
  }
  connect(signer: Signer): LiquidityMiningRewardDistributorStorage__factory {
  ...
  static connect(
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as LiquidityMiningRewardDistributorStorage;
  }
}
