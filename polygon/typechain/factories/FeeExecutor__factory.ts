...
import type { FeeExecutor, FeeExecutorInterface } from "../FeeExecutor";
...
export class FeeExecutor__factory {
  ...
  static createInterface(): FeeExecutorInterface {
    return new utils.Interface(_abi) as FeeExecutorInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): FeeExecutor {
    return new Contract(address, _abi, signerOrProvider) as FeeExecutor;
  }
}
