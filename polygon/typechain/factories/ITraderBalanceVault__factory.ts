...
export class ITraderBalanceVault__factory {
  ...
  static createInterface(): ITraderBalanceVaultInterface {
    return new utils.Interface(_abi) as ITraderBalanceVaultInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ITraderBalanceVault {
    return new Contract(address, _abi, signerOrProvider) as ITraderBalanceVault;
  }
}
