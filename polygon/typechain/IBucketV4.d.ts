...
interface IBucketV4Interface extends ethers.utils.Interface {
  functions: {
    ...
    "cumulateToLiquidityIndex(uint256,uint256)": FunctionFragment;
    ...
    "performFlashLoanTransfer(address,uint256)": FunctionFragment;
...
export class IBucketV4 extends BaseContract {
