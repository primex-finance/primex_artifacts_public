...
interface BucketMockInterface extends ethers.utils.Interface {
  functions: {
    ...
    "normalizedIncome()": FunctionFragment;
    ...
    "setBucketExtension(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "normalizedIncome",
    values?: undefined
  ): string;
  ...
  events: {
    ...
    "ChangedBucketExtension(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "ChangedBucketExtension"): EventFragment;
...
export type ChangedBucketExtensionEvent = TypedEvent<
  [string] & { newBucketExtension: string }
>;
...
export class BucketMock extends BaseContract {
  ...
  functions: {
    ...
    normalizedIncome(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  filters: {
    ...
    "ChangedBucketExtension(address)"(
      newBucketExtension?: null
    ): TypedEventFilter<[string], { newBucketExtension: string }>;
  ...
  populateTransaction: {
    ...
    normalizedIncome(overrides?: CallOverrides): Promise<PopulatedTransaction>;
