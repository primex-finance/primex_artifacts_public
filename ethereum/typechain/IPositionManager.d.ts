...
interface IPositionManagerInterface extends ethers.utils.Interface {
  functions: {
    ...
    "closePosition(uint256,address,tuple[],uint256)": FunctionFragment;
    "closePositionByCondition(uint256,address,tuple[],uint256,bytes,uint8)": FunctionFragment;
    "decreaseDeposit(uint256,uint256)": FunctionFragment;
    ...
    "partiallyClosePosition(uint256,uint256,address,tuple[],uint256)": FunctionFragment;
    ...
    "setMinPositionSize(uint256,address)": FunctionFragment;
  ...
  events: {
    ...
    "MinPositionSizeAndAssetChanged(uint256,address)": EventFragment;
    "OpenPosition(uint256,address,address,tuple,address,uint256,uint256,uint256,tuple[])": EventFragment;
  ...
  getEvent(
    nameOrSignatureOrTopic: "MinPositionSizeAndAssetChanged"
  ): EventFragment;
...
export type MinPositionSizeAndAssetChangedEvent = TypedEvent<
  [BigNumber, string] & {
    _minPositionSize: BigNumber;
...
export class IPositionManager extends BaseContract {
  ...
  filters: {
    ...
    "MinPositionSizeAndAssetChanged(uint256,address)"(
      _minPositionSize?: BigNumberish | null,
      _minPositionAsset?: string | null
    ): TypedEventFilter<
      [BigNumber, string],
      { _minPositionSize: BigNumber; _minPositionAsset: string }
    >;
    ...
    "OpenPosition(uint256,address,address,tuple,address,uint256,uint256,uint256,tuple[])"(
      positionId?: BigNumberish | null,
      trader?: string | null,
