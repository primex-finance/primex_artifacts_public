...
import type { BucketStorage, BucketStorageInterface } from "../BucketStorage";
...
export class BucketStorage__factory {
  ...
  static createInterface(): BucketStorageInterface {
    return new utils.Interface(_abi) as BucketStorageInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BucketStorage {
    return new Contract(address, _abi, signerOrProvider) as BucketStorage;
  }
}
