...
} from "../SynchronizationBotLensQuickswapTestService";
...
export class SynchronizationBotLensQuickswapTestService__factory extends ContractFactory {
  ...
  ): Promise<SynchronizationBotLensQuickswapTestService> {
    return super.deploy(
      overrides || {}
    ) as Promise<SynchronizationBotLensQuickswapTestService>;
  }
  ...
  attach(address: string): SynchronizationBotLensQuickswapTestService {
    return super.attach(address) as SynchronizationBotLensQuickswapTestService;
  }
  connect(signer: Signer): SynchronizationBotLensQuickswapTestService__factory {
  ...
  static connect(
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as SynchronizationBotLensQuickswapTestService;
  }
}
