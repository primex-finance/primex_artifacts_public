...
import type { IBucket, IBucketInterface } from "../IBucket";
...
export class IBucket__factory {
  ...
  static createInterface(): IBucketInterface {
    return new utils.Interface(_abi) as IBucketInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IBucket {
    return new Contract(address, _abi, signerOrProvider) as IBucket;
  }
}
