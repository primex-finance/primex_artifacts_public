...
import type { IDexAdapter, IDexAdapterInterface } from "../IDexAdapter";
...
export class IDexAdapter__factory {
  ...
  static createInterface(): IDexAdapterInterface {
    return new utils.Interface(_abi) as IDexAdapterInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IDexAdapter {
    return new Contract(address, _abi, signerOrProvider) as IDexAdapter;
  }
}
