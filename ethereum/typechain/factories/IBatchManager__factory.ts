...
import type { IBatchManager, IBatchManagerInterface } from "../IBatchManager";
...
export class IBatchManager__factory {
  ...
  static createInterface(): IBatchManagerInterface {
    return new utils.Interface(_abi) as IBatchManagerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IBatchManager {
    return new Contract(address, _abi, signerOrProvider) as IBatchManager;
  }
}
