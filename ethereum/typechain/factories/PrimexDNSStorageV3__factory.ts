...
export class PrimexDNSStorageV3__factory {
  ...
  static createInterface(): PrimexDNSStorageV3Interface {
    return new utils.Interface(_abi) as PrimexDNSStorageV3Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PrimexDNSStorageV3 {
    return new Contract(address, _abi, signerOrProvider) as PrimexDNSStorageV3;
  }
}
