...
interface IPrimexDNSV3Interface extends ethers.utils.Interface {
  functions: {
...
export class IPrimexDNSV3 extends BaseContract {
  ...
  interface: IPrimexDNSV3Interface;
  ...
  functions: {
    ...
    setProtocolFeeRate(
      _feeRateType: { feeRateType: BigNumberish; feeRate: BigNumberish },
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
