...
import type { LimitPriceCOM, LimitPriceCOMInterface } from "../LimitPriceCOM";
...
export class LimitPriceCOM__factory extends ContractFactory {
  ...
  ): Promise<LimitPriceCOM> {
    return super.deploy(_registry, overrides || {}) as Promise<LimitPriceCOM>;
  }
  ...
  attach(address: string): LimitPriceCOM {
    return super.attach(address) as LimitPriceCOM;
  }
  connect(signer: Signer): LimitPriceCOM__factory {
    return super.connect(signer) as LimitPriceCOM__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): LimitPriceCOMInterface {
    return new utils.Interface(_abi) as LimitPriceCOMInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LimitPriceCOM {
    return new Contract(address, _abi, signerOrProvider) as LimitPriceCOM;
  }
}
