...
import type { IBucketV2, IBucketV2Interface } from "../IBucketV2";
...
export class IBucketV2__factory {
  ...
  static createInterface(): IBucketV2Interface {
    return new utils.Interface(_abi) as IBucketV2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IBucketV2 {
    return new Contract(address, _abi, signerOrProvider) as IBucketV2;
  }
}
