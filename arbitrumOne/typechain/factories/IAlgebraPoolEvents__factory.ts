...
export class IAlgebraPoolEvents__factory {
  ...
  static createInterface(): IAlgebraPoolEventsInterface {
    return new utils.Interface(_abi) as IAlgebraPoolEventsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IAlgebraPoolEvents {
    return new Contract(address, _abi, signerOrProvider) as IAlgebraPoolEvents;
  }
}
