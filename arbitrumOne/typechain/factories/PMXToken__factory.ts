...
import type { PMXToken, PMXTokenInterface } from "../PMXToken";
...
export class PMXToken__factory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(_recipient, overrides || {}) as Promise<PMXToken>;
  }
  ...
  attach(address: string): PMXToken {
    return super.attach(address) as PMXToken;
  }
  connect(signer: Signer): PMXToken__factory {
    return super.connect(signer) as PMXToken__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): PMXTokenInterface {
    return new utils.Interface(_abi) as PMXTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PMXToken {
    return new Contract(address, _abi, signerOrProvider) as PMXToken;
  }
}
