...
import type { IPrimexDNSV3, IPrimexDNSV3Interface } from "../IPrimexDNSV3";
...
export class IPrimexDNSV3__factory {
  ...
  static createInterface(): IPrimexDNSV3Interface {
    return new utils.Interface(_abi) as IPrimexDNSV3Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IPrimexDNSV3 {
    return new Contract(address, _abi, signerOrProvider) as IPrimexDNSV3;
  }
}
