...
import type { IPrimexLens, IPrimexLensInterface } from "../IPrimexLens";
...
export class IPrimexLens__factory {
  ...
  static createInterface(): IPrimexLensInterface {
    return new utils.Interface(_abi) as IPrimexLensInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IPrimexLens {
    return new Contract(address, _abi, signerOrProvider) as IPrimexLens;
  }
}
