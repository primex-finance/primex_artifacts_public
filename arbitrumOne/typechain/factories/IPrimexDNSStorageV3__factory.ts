...
export class IPrimexDNSStorageV3__factory {
  ...
  static createInterface(): IPrimexDNSStorageV3Interface {
    return new utils.Interface(_abi) as IPrimexDNSStorageV3Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IPrimexDNSStorageV3 {
    return new Contract(address, _abi, signerOrProvider) as IPrimexDNSStorageV3;
  }
}
