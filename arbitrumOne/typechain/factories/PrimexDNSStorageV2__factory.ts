...
export class PrimexDNSStorageV2__factory {
  ...
  static createInterface(): PrimexDNSStorageV2Interface {
    return new utils.Interface(_abi) as PrimexDNSStorageV2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): PrimexDNSStorageV2 {
    return new Contract(address, _abi, signerOrProvider) as PrimexDNSStorageV2;
  }
}
