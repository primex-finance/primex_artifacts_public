...
export class IFlashLoanManager__factory {
  ...
  static createInterface(): IFlashLoanManagerInterface {
    return new utils.Interface(_abi) as IFlashLoanManagerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IFlashLoanManager {
    return new Contract(address, _abi, signerOrProvider) as IFlashLoanManager;
  }
}
