...
interface MixedRouteQuoterV1Interface extends ethers.utils.Interface {
  functions: {
    ...
    "factorySushi()": FunctionFragment;
    "factoryV2()": FunctionFragment;
    "quoteExactInput(bytes,uint256)": FunctionFragment;
    "quoteExactInputSingleSushi((address,address,uint256))": FunctionFragment;
...
export class MixedRouteQuoterV1 extends BaseContract {
  ...
  functions: {
    ...
    factorySushi(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    factorySushi(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    factorySushi(overrides?: CallOverrides): Promise<PopulatedTransaction>;
