...
export class IQuoter extends BaseContract {
  ...
  callStatic: {
    quoteExactInput(
      ...
      [BigNumber, number[]] & { amountOut: BigNumber; fees: number[] }
    >;
    ...
    quoteExactInputSingle(
      ...
      limitSqrtPrice: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber, number] & { amountOut: BigNumber; fee: number }>;

    quoteExactOutput(
      path: BytesLike,
      amountOut: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber, number[]] & { amountIn: BigNumber; fees: number[] }>;
    ...
    quoteExactOutputSingle(
      ...
      limitSqrtPrice: BigNumberish,
      overrides?: CallOverrides
    ): Promise<[BigNumber, number] & { amountIn: BigNumber; fee: number }>;
  };
