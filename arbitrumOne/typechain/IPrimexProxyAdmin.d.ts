...
interface IPrimexProxyAdminInterface extends ethers.utils.Interface {
  functions: {
    "changeBeaconProxyAdmin(address,address)": FunctionFragment;
...
export class IPrimexProxyAdmin extends BaseContract {
